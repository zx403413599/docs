...
3.将anaconda3/bin 加入永久环境变量  
    1.export PATH=$PATH:/home/wangjianlong/anaconda3/bin
	2.vi /etc/profile 最后面加入 export PATH=$PATH:/home/wangjianlong/anaconda3/bin
	3.source /etc/profile
	4.开启另外一个终端 输入python 看是否成功
...
7.使用pip install package_name(如requests） 下载第三方库 若下载不了 将anaconda/bin/pip 复制到 /usr/bin  替换该文件夹下的pip 需要授予/usr/bin 777权限 也要授予/usr/bin/pip 777权限
